...
function Kachari_Basti() {
    let { placename } = useParams();
    const baseurl1 = 'http://localhost:4000/api/medical/11KV_KACHARI_BASTI';
    const baseurl2 = 'http://localhost:4000/api/fidder/11KV_KACHARI_BASTI';
