...
function KV_TV() {
    ...
    const baseurl1 = 'http://localhost:4000/api/medical/11KV_TV';
    const baseurl2 = 'http://localhost:4000/api/fidder/11KV_TV';
    ...
    return (
        <div className='table_feeder'>
            ...
            <div className="name">11KV_TV</div>
